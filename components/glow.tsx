...
>(({ className, variant, ...props }, ref) => (
  ...
  >
    ...
    <div
      className={cn(
        "absolute left-1/2 h-[128px] w-[70%] -translate-x-1/2 scale-[2] rounded-[50%] bg-[radial-gradient(ellipse_at_center,_hsla(var(--brand)/.3)_10%,_hsla(var(--brand-foreground)/0)_60%)] sm:h-[256px]",
        variant === "center" && "-translate-y-1/2"
      )}
    />
  </div>
